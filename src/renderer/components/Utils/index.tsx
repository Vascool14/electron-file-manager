...
export const getLogoImage = (extension: string) => {
  ...
  switch (lowerCase) {
    ...
    case ".docx" || ".doc": return WordLogo;
    case ".xls": return XlsxLogo;
    case ".xlsx": return XlsxLogo;
    //ppt:
    case ".ppt": return PptLogo;
    case ".pptx": return PptLogo; // text:
    case ".rtf": return TxtLogo;
    case ".txt": return TxtLogo;
    // image
    case ".jpg": return JpgLogo;
    case ".jpeg": return JpegLogo;
    case ".png": return PngLogo;
    case ".gif": return GifLogo;
    //video
    case ".mp4": return Mp4Logo;
    case ".avi": return AviLogo;
    case ".mkv": return MkvLogo;
    case ".mov": return MovLogo;
    // audio
    case ".mp3": return Mp3Logo;
    case ".wav": return WavLogo;
    case ".flac": return FlacLogo;
    // archive
    case ".zip": return ZipLogo;
    case ".rar": return RarLogo;
    case ".tar.gz": return TarLogo;
    // html
    case ".html": return HtmlLogo;
    // css
    case ".css": return CssLogo;
    // json
    case ".json": return JsonLogo;
    // xml
    case ".xml": return XmlLogo;
    // csv
    case ".csv": return CsvLogo;
    // database
    case ".db": return DbLogo;
    case ".sqlite": return DbLogo;
    // executable
    case ".msi": return ExeLogo;
    case ".exe": return ExeLogo;
    // shell
    case ".sh": return ShLogo;
    case ".jsx": return JavaScriptLogo;
    case ".tsx": return TypeScriptLogo;
    case ".js": return JavaScriptLogo;
    case ".ts": return TypeScriptLogo;
    case ".java": return JavaLogo;
    case ".py": return PythonLogo;
    case ".c" || ".cpp": return CppLogo;
    case ".cs": return CSharpLogo;
    case ".php": return PhpLogo;
    case ".rb": return RubyLogo;
    case ".swift": return SwiftLogo;
    case ".go": return GoLogo;
    case ".rust": return RustLogo;
    case ".perl": return PerlLogo;
    case ".lua": return LuaLogo;
    case ".directory": return DirectoryLogo;
    case ".svg": return SvgLogo;
    default:
